...
class TestCase_3:
    ...
    def internet_on(self):
        ...
        client2 = pxssh.pxssh()  
        try:  
            client1.login(HOST1, USER1, original_prompt=' ',port = '50046',auto_prompt_reset=False)
            client2.login(HOST2, USER2, original_prompt=' ',port = '50045',auto_prompt_reset=False)
        except:
            return "fail"
        try:
